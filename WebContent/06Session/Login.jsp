...
<%
//로그인이 되었는지 확인하기위해 세션영역에서 속성을 가져온다.
	...
	<table border='1'>
		<tr>
			<td style="text-align:center;">
				<!--  
				1단계 : 쿼리문에 count(*) 그룹함수를 사용하여 로그인 처리를 하므로 회원의 이름이 null로 출력된다.
				
				2단계 : 쿼리를 통해 얻어온 회원정보를 MemberDTO객체에 저장후 반환받고, 세션영역에 각 정보들을 저장한다.
				-->
