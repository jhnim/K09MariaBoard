 ...
 */
	function checkValidate(fm){
		...
		if(fm.content.value==""){
            ...
            <!--  
            	해당 게시물의 일련번호를 전송해야 수정이 가능하다. hidden속성으로 처리하면 화면에서는 숨김처리 되지만,
            	서버로는 값을 전송할 수 있다. 또한 update의 특성으로 이해할 수도 있다.
            	update 테이블 set 컬럼=값 -> where절이 없다면 모든 게시물에 대한 수정이 된다.
            -->
